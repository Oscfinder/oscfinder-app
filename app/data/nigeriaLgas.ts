// State -> Local Government Areas, keyed to match NIGERIAN_STATES in newCompaniesData.ts exactly.
// Used to populate the LGA dropdown in the Add Lead form once a State is chosen.
