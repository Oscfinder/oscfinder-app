  ...
  if (!sender || sender.status !== 'verified') {
    return (
      <LockedFeatureCard
        ...
        description="Connect and verify your own mailbox (e.g. Zoho, Gmail, Outlook) so campaign emails go out from your own domain instead of a shared platform address."
